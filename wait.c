...
/*
int ksleep(int event) {}  // YOUR sleep function
// wake up ALL procs sleeping on event
int kwakeup(int event) {}  // YOUR wakeup function
int kexit(int exitCode) {}  // YOUR exit function
int kwait(int *status) {}  // YOUR wait function
*/
...
//////////////////////////////////////////////////////
	...
	while (1)
	{
		...
		printf("PROC %d did not find any ZOMBIE children, so they are going back to sleep.\n", running->pid);
...
//int printSleepQueue (PROC *sleeplist)
//{
//	PROC *tmp;
//	tmp = sleepList;
//
